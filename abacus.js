...
function initAbacus(canvasElement, pElement) {
    ...
    var style = "border: ridge 2px #99aabb; padding: 0; width: "
        + (primary.abacusCanvasElement.width - 4)
        + "px; margin: 0; text-align: right; "
        + "line-height: 23px; color: " + primary.border;
    document.getElementById("abacus_p").setAttribute("style", style);
...
function initLeeAbacus(canvas0Element, canvas1Element, canvasElement,
    ...
    for (var i = 0; i < number; i++) {
        ...
        abaci[i].setSize();
        var style = "border: ridge 2px #99aabb; padding: 0; width: "
            + (abaci[i].abacusCanvasElement.width - 4)
            + "px; margin: 0; text-align: right; "
            + "line-height: 23px; color: " + abaci[i].border;
        document.getElementById((i === number - 1) ?
            "primary_p" : "auxiliary" + i + "_p").setAttribute("style", style);
